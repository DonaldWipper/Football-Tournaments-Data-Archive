...
#
#
# def write_mysql(df: pd.DataFrame) -> None:
#     print(df)
#     df.to_sql(
#         name="tournament_calendar", con=DBConnection.get_engine(), if_exists="append", index=False
#     )
#
#
# def retrieve_seasons() -> None:
...
#     aws_access_key_id = 'YCAJExaM56WDU0uanHD0c0va0'
#     aws_secret_access_key = 'YCOaJerZZ787iQkbyI-68ZMJi2hoIZc_Kr1YPGLD'
